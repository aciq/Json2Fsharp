// copied from FSharp.Data
// https://github.com/fsprojects/FSharp.Data/blob/fd0fbccdbca7c697c8a30012754f77225b045ed1/src/Json/JsonInference.fs

module Json2Fsharp.Inference
...
let rec internal inferType unitsOfMeasureProvider inferenceMode cultureInfo parentName json =
    ...
    let shouldInferNonStringFromValue = true
    ...
    | JsonValue.String s -> StructuralInference.getInferedTypeFromString unitsOfMeasureProvider inferenceMode cultureInfo s None
