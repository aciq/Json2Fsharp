...
//            
//            let conf = config :?> JsonClassGenerator
//            
//            let allTypes : JsonType list = conf.Types |> Seq.toList
//            
//            let w1fields = allTypes[0].Fields
//            
//            let root = allTypes |> Seq.find (fun f -> f.IsRoot = true)
//            
//            
//            
//                
//                
////            let jt = JsonType
//            let mainfields = config.CollectionType
//            
//            sw
//            |> SB.appendLine ""
//            |> ignore
